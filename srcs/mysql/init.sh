...
echo "CREATE USER 'wp-admin' IDENTIFIED BY 'password';" | mysql -u root -p --skip-password
echo "GRANT ALL PRIVILEGES ON wordpress.* TO wp-admin;" | mysql -u root -p --skip-password
